...
```bash
$sam local invoke --debug-port 5858 --env-vars env.json --event events/Alexa.Discovery.Discover.json webthing
```
...
```bash
aws cloudformation delete-stack --stack-name sam-webthingalexa
```
